...
VALUES
    ...
    (3,
     ...
     '{"VP4": true}',
     '{"type":"PRESSURE_ANOMALY","elementName":"PT2","message":"Давление на выходе АУМО-400 превышает 75 ати! Необходимо стравить давление через дренаж.","lockElement":false}',
